                    ...
                    <div className="w-full max-w-md space-y-4">
                      <div className="p-4 bg-[#05070a] border border-slate-800 rounded-lg flex flex-col gap-2 relative group hover:border-[#f7931a]/50 transition-colors">
                        ...
                        <div className="flex items-center justify-between gap-3 text-slate-300 font-mono text-sm break-all">
                          <span>17xZF4rAa7yPXse4YpTApwiu7MXttmnbY6</span>
                          <button onClick={() => navigator.clipboard.writeText('17xZF4rAa7yPXse4YpTApwiu7MXttmnbY6')} className="p-2 bg-slate-800 rounded hover:bg-slate-700 transition-colors shrink-0 text-slate-400 group-hover:text-white" title="Copy BTC Address">
                      ...
                      <div className="p-4 bg-[#05070a] border border-slate-800 rounded-lg flex flex-col gap-2 relative group hover:border-[#26a17b]/50 transition-colors">
                        ...
                        <div className="flex items-center justify-between gap-3 text-slate-300 font-mono text-sm break-all">
                          <span>TWNNbpFjjmM4QsNNGMVqzHEf7ZyaURwRQZ</span>
                          <button onClick={() => navigator.clipboard.writeText('TWNNbpFjjmM4QsNNGMVqzHEf7ZyaURwRQZ')} className="p-2 bg-slate-800 rounded hover:bg-slate-700 transition-colors shrink-0 text-slate-400 group-hover:text-white" title="Copy USDT Address">
                            <Copy className="w-4 h-4" />
                          </button>
                        </div>
                      </div>
